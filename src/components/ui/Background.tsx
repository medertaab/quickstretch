        ...
        >
          <defs>
            <filter id="inner-glow">
              <feFlood floodColor="rgb(251, 255, 0)" />
...
const FlowingBackground = styled.div<{ theme: String, inExercise: Boolean }>`
  ...
  .star-under {
    ...
    position: absolute;
    fill: #ff2ea8;
    animation: fade-in 2s ease-in, rotate 17s infinite linear;
    z-index: -1;
    filter: blur(20px);
    top: -0.2rem;
  }
